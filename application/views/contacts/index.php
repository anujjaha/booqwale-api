...
<section class="content">
	...
	<div class="box">
        ...
        <h3 class="box-title">
			  Contact List
		<a href="<?php echo site_url();?>contacts/create">Add More</a>	
		</h3>
        </div><!-- /.box-header -->
			...
			<?php
				...
				<tr id="record_<?php echo $contact['contact_id'];?>">
					...
					<td> 
						...
						$imagePath = FCPATH."assets/profilepicuters/".$contact['profile_picture'];

						if(file_exists($imagePath))
						{
							$showImage = site_url()."assets/profilepicuters/".$contact['profile_picture'];
						?>
						
							<img class="profile-picture" src="<?php echo $showImage;?>">
						...
						<?php
							...
							{
								?>
								<img class="profile-picture" src="<?php echo site_url('assets/profilepicuters/default.png');?>">
								<?php
							}
						?>
					...
					<td>
						...
						<a href="javascript:void(0);" onclick="deleteContact(<?php echo $contact['contact_id'];?>);">
...
function deleteContact(id) {
	var status = confirm("Do you want to Delete Contact ?");
	...
	$.ajax({
         type: "POST",
         url: "<?php echo site_url();?>/ajax/ajax_delete_contact/"+id, 
         success: 
            function(data) {
            		return true;
            }
